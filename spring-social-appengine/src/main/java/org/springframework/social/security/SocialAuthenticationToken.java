 ...
 * 注意：
 *
 * 當使用者以 sign-in with social account 登入後，此 SocialAuthenticationToken 將被儲存到 session 中，
 * 但是 Connection 類別不支援 Serializable，因此會發生錯誤，故須將該參考修正為 transient。
 *
 * 詳細說明請參考 ProviderSignInAttempt.java 的修正說明。
 *
 * 此問題的 Issue Tracker:
 *
 * Persistent session managment - NotSerializableException for OAuth2Connection and OAuth1Connection
 * https://jira.springsource.org/browse/SOCIAL-355
 */
