...
public class SocialAuthenticationProvider implements AuthenticationProvider {
    ...
    protected String toUserId(Connection<?> connection) {
        ...
        /**
         * 注意：當同一個 social account 連結到兩個 native account，
         * 卻認定完全沒有連結，當作認證失敗，這樣不太好吧？
         *
         * 已報告此問題；
         * SocialAuthenticationProvider should support multiple connections
         * https://jira.springsource.org/browse/SOCIAL-402
         *
         */
        //return (userIds.size() == 1) ? userIds.iterator().next() : null;
        // 注意：暫時修正為取第一個連結(應該要報告這種狀況，列出所有的連結供 user 選擇)：
        return (userIds.size() != 0) ? userIds.iterator().next() : null;
    }
