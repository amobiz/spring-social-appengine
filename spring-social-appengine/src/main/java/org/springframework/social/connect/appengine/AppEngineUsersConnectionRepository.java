...
public class AppEngineUsersConnectionRepository implements UsersConnectionRepository {
	...
	public ConnectionRepository createConnectionRepository(String userId) {
		...
		AppEngineConnectionRepository repo = new AppEngineConnectionRepository(userId, this.connectionFactoryLocator, this.textEncryptor, this.datastore, this.kindPrefix, this.namespace);
		repo.setInterceptors(this.interceptors);
		return repo;
	}
